...
class C_UMKM extends CI_Controller {
	...
	public function Read()
	{
		...
		$SQL = "SELECT a.*,b.JenisUsaha NamaJenisUsaha FROM tumkm a
				LEFT JOIN tjenisusaha b on a.JenisUsaha = b.ID
				 ";
		...
		if ($id == '') {
			...
			$rs = $this->ModelsExecuteMaster->FindData(array('ID'=>$id),'tumkm');
		}
